...
2026-09-11 根据实机反馈修正作品展示语义：原 `海报墙` 恢复为 `poster` 竖版海报，JavBoss 式 `fanart` 卡片作为新增的独立 `封面墙`，并以 contain 方式完整展示图片；视图切换扩展为海报墙 / 封面墙 / 瀑布流 / 列表 / 表格五项。自动检查已通过，等待用户实机验收图片比例与信息密度。
