...
export function parsePersonQuery(
  ...
  return {
    ...
    birthPlaceText: first(params.birthPlace),
    cupSizes: many(params.cup),
    heightMin: toOptionalNumber(first(params.heightMin)),
    heightMax: toOptionalNumber(first(params.heightMax)),
    hasPortrait: toOptionalBoolean(first(params.hasPortrait)),
    hasBirthDate: toOptionalBoolean(first(params.hasBirthDate)),
    hasHeight: toOptionalBoolean(first(params.hasHeight)),
    hasMeasurements: toOptionalBoolean(first(params.hasMeasurements)),
    hasBiography: toOptionalBoolean(first(params.hasBiography)),
