...
const messages = {
  ja: {
    ...
    review_required_classification: "分類語「{detail}」は認識されていますが、意味が複数あるため確認が必要です。",
  ...
  "zh-CN": {
    ...
    review_required_classification: "来源分类词“{detail}”已识别，但存在复合或多义语义，需要人工审核。",
  ...
  en: {
    ...
    review_required_classification: 'Source classification term "{detail}" is recognized but ambiguous and requires review.',
