...
export const desktopBridge = {
  ...
  deleteManagedPrivateLibrary: (profileId: string, expectedPath: string) => invoke<void>("delete_managed_private_library", { profileId, expectedPath }),
  ...
  pickFfprobeFile: (initialPath?: string) => invoke<string | null>("pick_ffprobe_file", { initialPath }),
  checkFfprobe: (executable: string) => invoke<string>("check_ffprobe", { executable }),
