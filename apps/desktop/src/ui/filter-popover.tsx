 ...
 */
export function FilterPopover({ children, count = 0, label, wide = false }: {
  children: ReactNode;
  count?: number;
  label: ReactNode;
  wide?: boolean;
  ...
  return <div className="desktop-filter-menu-anchor" ref={anchorRef}>
    ...
    {open ? <section aria-label={typeof label === "string" ? label : undefined} className={wide ? "desktop-filter-menu is-wide" : "desktop-filter-menu"}>
